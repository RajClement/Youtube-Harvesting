...
client=pymongo.MongoClient("mongodb+srv://user2024:testraj123@cluster0.3n8ejf5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
with st.sidebar:
    st.title(":blue[YOUTUBE DATA HARVESTING AND WAREHOUSE]")
...
elif question== "2. The most number of videos":
...
if question== "4. Comments were made on each video":
...
elif question== "10. Highest number of comments":
